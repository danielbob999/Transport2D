...
void GroundBodyComponent::generate() {
		...
		m_ground1Body = PhysicsSystem::getInstance()->getWorld()->CreateBody(&bd);
	{
		...
		float js[500] = { 8.4, 8.9, 9.4, 9.9, 10.4, 12.0, 13.0, 14.5, 15.7, 16.3, 18.0, 19.0, 19.5, 19.4, 19.7, 19.8, 20.1, 18.3, 16.9, 15.9, 15.9, 16.2, 17.2, 17.8, 18.6, 18.9, 19.4, 20.2, 20.5, 21.1, 22.5, 22.8, 23.3, 24.4, 23.0, 22.5, 21.5, 19.5, 18.2, 19.8, 18.4, 17.5, 16.8, 16.1, 15.0, 14.7, 13.2, 12.9, 12.9, 12.9, 12.9, 11.5, 10.4, 9.9, 8.6, 7.0, 7.8, 6.5, 5.4, 4.4, 4.4, 5.4, 6.5, 7.2, 7.2, 6.5, 5.4, 4.4, 4.4, 5.4, 5.4 , 5.4 , 5.4 , 5.4 , 5.4 , 5.4 , 5.4 , 5.4 , 5.4 , 5.4 , 5.4 , 5.4 };
		y1 = js[0];
		x = 210;
